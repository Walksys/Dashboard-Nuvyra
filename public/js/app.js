// Nuvyra Application Core & Router
class App {
  constructor() {
        ...
        <div class="w-full max-w-sm rounded-3xl overflow-hidden border border-indigo-500/30 bg-[#111214] text-slate-200 shadow-2xl relative animate-scale-in font-sans max-h-[92vh] flex flex-col">
          ...
          <div class="p-3 bg-[#111214] border-t border-white/5 space-y-2 shrink-0">
            <div class="grid grid-cols-2 gap-2">
              <a href="https://discord.com/users/1476587556962308177" target="_blank" class="py-2 px-3 rounded-xl bg-[#5865F2] hover:bg-[#4752C4] text-white text-xs font-bold flex items-center justify-center gap-1.5 transition shadow-md shadow-indigo-500/20 active:scale-95">
              ...
              <a href="https://walksyshost.in/" target="_blank" class="py-2 px-3 rounded-xl bg-cyan-500 hover:bg-cyan-400 text-slate-950 text-xs font-bold flex items-center justify-center gap-1.5 transition shadow-md shadow-cyan-500/20 active:scale-95">
                <i data-lucide="globe" class="w-3.5 h-3.5"></i>
                <span>walksyshost.in</span>
              </a>
            </div>

            <div class="grid grid-cols-2 gap-2">
              <button onclick="app.copyToClipboard('<@1476587556962308177>')" class="py-1.5 px-2.5 rounded-xl bg-white/5 hover:bg-white/10 text-slate-300 text-[11px] font-mono flex items-center justify-center gap-1.5 border border-white/10 transition active:scale-98">
                <i data-lucide="copy" class="w-3 h-3 text-purple-400"></i>
                <span>&lt;@1476587556962308177&gt;</span>
              </button>
              <button onclick="app.copyToClipboard('1476587556962308177')" class="py-1.5 px-2.5 rounded-xl bg-white/5 hover:bg-white/10 text-slate-300 text-[11px] font-mono flex items-center justify-center gap-1 border border-white/10 transition active:scale-98">
                <i data-lucide="hash" class="w-3 h-3 text-cyan-400"></i>
                <span>ID: 1476587556962308177</span>
              </button>
            </div>
          </div>
        </div>
