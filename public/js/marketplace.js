// Nuvyra Marketplace Module - Modrinth, CurseForge & SpigotMC Store + Properties UI & Tools
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 pt-2">
          <div class="glass-panel p-5 rounded-2xl border border-white/10 space-y-2">
            ...
            <p class="text-[11px] text-slate-400 leading-relaxed">
              Nuvyra installs the official Playit plugin into your server plugins or mods directory automatically.
            </p>
          </div>
...
sudo apt install -y playit</pre>
            <p class="text-[10px] text-slate-400">
              💡 You can also install it anytime via Nuvyra CLI: <code>./menu.sh playit</code> or <code>bash menu.sh</code> (Option 8).
            </p>
          </div>
        </div>
      </div>
  ...
  syncPropertiesToRaw() {
    let raw = this.rawProperties || `# Minecraft server properties generated by Nuvyra\n# ${(new Date()).toISOString()}\n`;
          ...
          <div class="flex items-center gap-4">
            ...
            <div class="space-y-1">
              <div class="flex items-center gap-2">
                ...
                <span class="text-[10px] text-slate-400 font-mono">by 0x7d8 • walksys</span>
              </div>
              <h4 class="text-xl font-black text-white flex items-center gap-2">
                Server Splitter
              </h4>
